...
urlpatterns = [
    ...
    path('index/<int:pk>/', views.RedirectViewClass.as_view(), name='index'),
    path('<int:pk>/', views.TemplateView.as_view(template_name = 'home.html'), name='new')
    # path('youtube/', views.RedirectView.as_view(url = 'https://www.youtube.com'), name='youtube')
    # path('youtube/', views.RedirectClass.as_view(), name='youtube')
